...
\begin{figure}
\inputminted[linenos, firstline=22, lastline=66]{python}{../metodos/eq_diferenciales.py}
...
\begin{figure}
\inputminted[linenos, firstline=1, lastline=41]{python}{../metodos/transformada_fourier.py}
...
\begin{figure}
\inputminted[linenos, firstline=43, lastline=83]{python}{../metodos/transformada_fourier.py}
\caption{Código de la Transformada de Fourier Discreta promedio cálculo del espectro de potencia}
\end{figure}

\begin{figure}
\inputminted[linenos, firstline=1, lastline=28]{python}{../graficas.py}
