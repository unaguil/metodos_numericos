...
\caption{Código del caso no lineal forzado y amortiguado para el conjunto de parámetros S1}
\end{figure}

\begin{figure}
\lstinputlisting[language=Python]{../caso_anarmonico_forzado_amortiguado_s2.py}
\caption{Código del caso no lineal forzado y amortiguado para el conjunto de parámetros S2}
\end{figure}
